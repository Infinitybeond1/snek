...
N_LIB_PRIVATE N_NIMCALL(void, quit__system_8108)(NimStringDesc* errormsg, NI errorcode) __attribute__((noreturn));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Rand__liBKmwv1H6v7oYBhDFHa6A, getRandomState__pureZrandom_259)(void) {
	...
	} LA1: ;
	{
		...
		if (!!(T16_)) goto LA17_;
		quit__system_8108(((NimStringDesc*) &TM__AIKkgex03Z1j45JceakCTA_3), ((NI) 1));
	}
	LA17_: ;
	return result;
}
