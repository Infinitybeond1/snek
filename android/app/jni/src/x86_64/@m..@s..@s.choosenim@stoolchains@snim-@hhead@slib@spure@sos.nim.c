...
static N_INLINE(NIM_CHAR, X5BX5D___system_8259)(NimStringDesc* s, NI i);
...
N_LIB_PRIVATE N_NIMCALL(void, joinPathImpl__pureZos_82)(NimStringDesc** result, NI* state, NimStringDesc* tail) {
	...
	if (!(T2_)) goto LA3_;
	T4_ = (NIM_CHAR)0;
	T4_ = X5BX5D___system_8259(tail, ((NI) 1));
	...
	if (!(T8_)) goto LA9_;
	T10_ = (NIM_CHAR*)0;
	T10_ = X5BX5D___system_8292(result, ((NI) 1));
...
{	result = NIM_NIL;
	...
	asgnRef((void**) (&(*e).Sup.Sup.message), osErrorMsg__pureZos_358(errorCode));
	{
		if (!(((NI) 0) < (additionalInfo ? additionalInfo->Sup.len : 0))) goto LA3_;
		{
			...
			if (!(T7_)) goto LA8_;
			T9_ = (NIM_CHAR*)0;
			T9_ = X5BX5D___system_8292((&(*e).Sup.Sup.message), ((NI) 1));
			T7_ = !(((NU8)((*T9_)) == (NU8)(10)));
			LA8_: ;
			if (!T7_) goto LA10_;
...
N_LIB_PRIVATE N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
			...
			while (1) {
				...
				i = res;
				{
					...
					LA10_: ;
					{
						...
						NIM_BOOL T14_;
						T13_ = NIM_NIL;
						T13_ = substr__system_8666(dir, ((NI) 0), (NI)(i - ((NI) 1)));
						T14_ = (NIM_BOOL)0;
	...
	}
	{
		...
		if (!(T17_)) goto LA20_;
		T21_ = (NIM_CHAR)0;
		T21_ = X5BX5D___system_8259(dir, ((NI) 1));
