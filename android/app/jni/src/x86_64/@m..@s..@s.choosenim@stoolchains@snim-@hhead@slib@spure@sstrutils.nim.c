...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString__pureZstrutils_2162)(NimStringDesc* formatstr);
...
N_LIB_PRIVATE N_NIMCALL(NI, findNormalized__pureZstrutils_2150)(NimStringDesc* x, NimStringDesc** inArray, NI inArrayLen_0);
				...
				{
					{
						...
						invalidFormatString__pureZstrutils_2162(formatstr);
					}
					LA12_: ;
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						NimStringDesc* T69_;
						T69_ = NIM_NIL;
						T69_ = substr__system_8666(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
						x = findNormalized__pureZstrutils_2150(T69_, a, aLen_0);
						{
							NIM_BOOL T72_;
							T72_ = (NIM_BOOL)0;
							T72_ = (((NI) 0) <= x);
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = NIM_NIL;
					T82_ = substr__system_8666(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
					x_2 = findNormalized__pureZstrutils_2150(T82_, a, aLen_0);
					{
						NIM_BOOL T85_;
						T85_ = (NIM_BOOL)0;
						T85_ = (((NI) 0) <= x_2);
