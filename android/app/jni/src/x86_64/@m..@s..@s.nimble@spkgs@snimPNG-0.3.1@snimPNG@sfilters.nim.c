		...
		}
		{
			...
			i_6 = byteWidth;
			{
				while (1) {
					...
					i_5 = i_6;
					output[i_5] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_5]))))) + (NU64)(((NU) (((NU8)(output[(NI)(i_5 - byteWidth)])))))) & ((NU) 255))));
					i_6 += ((NI) 1);
				} LA11: ;
			}
		}
		...
		}
		{
			...
			i_12 = byteWidth;
			{
				while (1) {
					...
					i_11 = i_12;
					output[i_11] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_11]))))) + (NU64)((NU)((NU64)(((NU) (((NU8)(output[(NI)(i_11 - byteWidth)]))))) / (NU64)(((NU) 2))))) & ((NU) 255))));
					i_12 += ((NI) 1);
				} LA22: ;
			}
		}
		...
		}
		{
			...
			i_16 = byteWidth;
			{
				while (1) {
					...
					i_15 = i_16;
					output[i_15] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_15]))))) + (NU64)(((NU) (((NU8)(output[(NI)(i_15 - byteWidth)])))))) & ((NU) 255))));
					i_16 += ((NI) 1);
				} LA29: ;
			}
		}
	...
	{
		{
			...
			i_8 = ((NI) 0);
			{
				while (1) {
					if (!(i_8 < len)) goto LA15;
					i_7 = i_8;
					output[i_7] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_7]))))) + (NU64)(((NU) (((NU8)(prevLine[i_7])))))) & ((NU) 255))));
					i_8 += ((NI) 1);
				} LA15: ;
			}
		}
	...
	{
		{
			...
			i_10 = ((NI) 0);
			{
				while (1) {
					if (!(i_10 < byteWidth)) goto LA19;
					i_9 = i_10;
					output[i_9] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_9]))))) + (NU64)((NU)((NU64)(((NU) (((NU8)(prevLine[i_9]))))) / (NU64)(((NU) 2))))) & ((NU) 255))));
					i_10 += ((NI) 1);
				} LA19: ;
			}
		}
		{
			...
			i_12 = byteWidth;
			{
				while (1) {
					if (!(i_12 < len)) goto LA22;
					i_11 = i_12;
					output[i_11] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_11]))))) + (NU64)((NU)((NU64)((NU)((NU64)(((NU) (((NU8)(output[(NI)(i_11 - byteWidth)]))))) + (NU64)(((NU) (((NU8)(prevLine[i_11]))))))) / (NU64)(((NU) 2))))) & ((NU) 255))));
					i_12 += ((NI) 1);
				} LA22: ;
			}
		}
	...
	{
		{
			...
			i_14 = ((NI) 0);
			{
				while (1) {
					if (!(i_14 < byteWidth)) goto LA26;
					i_13 = i_14;
					output[i_13] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_13]))))) + (NU64)(((NU) (((NU8)(prevLine[i_13])))))) & ((NU) 255))));
					i_14 += ((NI) 1);
				} LA26: ;
			}
		}
		{
			...
			i_16 = byteWidth;
			{
				while (1) {
					...
					output[i_15] = ((NIM_CHAR) ((NU)((NU)((NU64)(((NU) (((NU8)(input[i_15]))))) + (NU64)(T30_)) & ((NU) 255))));
					i_16 += ((NI) 1);
				} LA29: ;
			}
		}
...
N_LIB_PRIVATE N_NIMCALL(NI, readBitFromReversedStream__OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3675)(NI* bitptr, NIM_CHAR* bitstream, NI bitstreamLen_0) {
	NI result;
	result = (NI)0;
	result = (NI)((NI)((NI64)(((NI) (((NU8)(bitstream[(NI)((NI64)((*bitptr)) >> (NU64)(((NI) 3)))]))))) >> (NU64)((NI)(((NI) 7) - (NI)((*bitptr) & ((NI) 7))))) & ((NI) 1));
	(*bitptr) += ((NI) 1);
	return result;
}
N_LIB_PRIVATE N_NIMCALL(void, ampeq___OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3706)(NIM_CHAR* a, NIM_CHAR b) {
...
N_LIB_PRIVATE N_NIMCALL(void, setBitOfReversedStream__OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3693)(NI* bitptr, NIM_CHAR* bitstream, NI bitstreamLen_0, NI bit) {
	{
		...
		ampeq___OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3706((&bitstream[(NI)((NI64)((*bitptr)) >> (NU64)(((NI) 3)))]), ((NIM_CHAR) ((NI)((NU64) ~((NI)((NU64)(((NI) 1)) << (NU64)((NI)(((NI) 7) - (NI)((*bitptr) & ((NI) 7))))))))));
	}
	goto LA1_;
	LA3_: ;
	{
		bareq___OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3718((&bitstream[(NI)((NI64)((*bitptr)) >> (NU64)(((NI) 3)))]), ((NIM_CHAR) ((NI)((NU64)(((NI) 1)) << (NU64)((NI)(((NI) 7) - (NI)((*bitptr) & ((NI) 7))))))));
	}
	LA1_: ;
	(*bitptr) += ((NI) 1);
}
...
N_LIB_PRIVATE N_NIMCALL(void, setBitOfReversedStream0__OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_5178)(NI* bitptr, NIM_CHAR* bitstream, NI bitstreamLen_0, NI bit) {
	{
		if (!!((bit == ((NI) 0)))) goto LA3_;
		bareq___OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_3718((&bitstream[(NI)((NI64)((*bitptr)) >> (NU64)(((NI) 3)))]), ((NIM_CHAR) ((NI)((NU64)(bit) << (NU64)((NI)(((NI) 7) - (NI)((*bitptr) & ((NI) 7))))))));
	}
	LA3_: ;
	(*bitptr) += ((NI) 1);
}
...
N_LIB_PRIVATE N_NIMCALL(void, addColorBits__OOZOOZOnimbleZpkgsZnim8078714548O51O49Znim807871_7520)(NIM_CHAR* output, NI outputLen_0, NI index, NI bits, NI input) {
	...
	LA1_: ;
	p = (NI)(index & m);
	val = (NI)(input & (NI)((NI)((NU64)(((NI) 1)) << (NU64)(bits)) - ((NI) 1)));
	val = (NI)((NU64)(val) << (NU64)((NI)(bits * (NI)(m - p))));
